...
def maxwell_componentwise_theoretical(x, tt, mass):
    return (mass / (2 * math.pi * kbol * tt))**(0.5) * np.exp(-mass * x**2 /
                                                              (2 * kbol * tt))
    pass


plt.subplot(311)
n, bins, patches = plt.hist(particles.velocs[:, 0],
                            bins=100,
                            density=True,
                            facecolor='g',
                            alpha=0.5)
...
plt.subplot(312)
n, bins, patches = plt.hist(particles.velocs[:, 1],
                            bins=100,
                            density=True,
                            facecolor='r',
                            alpha=0.5)
...
plt.subplot(313)
n, bins, patches = plt.hist(particles.velocs[:, 2],
                            bins=100,
                            density=True,
                            facecolor='b',
                            alpha=0.5)
...
def maxwell_theoretical(x, tt, mass):
    return 4 * math.pi * (mass /
                          (2 * math.pi * kbol * tt))**(1.5) * x**2 * np.exp(
                              -mass * x**2 / (2 * kbol * tt))


n, bins, patches = plt.hist(speed,
                            bins=100,
                            density=True,
                            facecolor='k',
                            alpha=0.5)
